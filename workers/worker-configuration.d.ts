/* eslint-disable */
// Generated by Wrangler by running `wrangler types workers/worker-configuration.d.ts` (hash: 373100035d5fecf2cf9c32541800b793)
// Runtime types generated with workerd@1.20260828.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
	ARENA_CHANNEL: "sandwich-maxxing";
	SITE_STATE_URL: "https://sandwichmaxxing.com/arena-state.json";
	CLOUDFLARE_PAGES_DEPLOY_HOOK: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./arena-sync");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ARENA_CHANNEL" | "SITE_STATE_URL" | "CLOUDFLARE_PAGES_DEPLOY_HOOK">> {}
}
